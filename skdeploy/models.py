...
class Project(models.Model):   
    ...
    repo_username = models.CharField(u"svn用户名",max_length=50,null=True, blank=True)
    repo_password = models.CharField(u"svn密码",max_length=50,null=True, blank=True)
    repo_mode = models.CharField(u"上线方式：branch/tag",max_length=50,null=True, blank=True)
    repo_type = models.CharField(u"上线方式：git/svn",max_length=50,null=True, blank=True)
    deploy_from = models.CharField(u"宿主机存放clone出来的文件",max_length=50,null=True, blank=True)
    excludes = models.CharField(u"要排除的文件",max_length=50,null=True, blank=True)
    ...
    pre_deploy = models.CharField(u"部署前置任务",max_length=50,null=True, blank=True)
    post_deploy = models.CharField(u"同步之前任务",max_length=50,null=True, blank=True)
    pre_release = models.CharField(u"同步之前目标机器执行的任务",max_length=50,null=True, blank=True)
    post_release = models.CharField(u"同步之后目标机器执行的任务",max_length=50,null=True, blank=True)
...
class task(models.Model):
    ...
    project_id = models.ForeignKey(Project, verbose_name=u"所属", on_delete=models.SET_NULL, null=True, blank=True)
    action = models.CharField(u"登录用户",max_length=50)
    ...
    link_id = models.CharField(u"登录用户",max_length=50)
    ex_link_id = models.CharField(u"登录用户",max_length=50)
    commit_id = models.CharField(u"登录用户",max_length=50)
    branch = models.CharField(u"登录用户",max_length=50)
    file_transmission_mode = models.CharField(u"登录用户",max_length=50)
    file_list = models.CharField(u"登录用户",max_length=50)
    enable_rollback = models.CharField(u"登录用户",max_length=50)
    created_at = models.DateTimeField(u'创建时间', auto_now_add=True,null=True)
    updated_at_l1 = models.DateTimeField(u'创建时间', auto_now_add=True,null=True)
    updated_at_l2 = models.DateTimeField(u'创建时间', auto_now_add=True,null=True)
    updated_at_l3 = models.DateTimeField(u'创建时间', auto_now_add=True,null=True)
    def __unicode__(self):
