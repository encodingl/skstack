...
class ProjectGroup(models.Model):
    name = models.CharField(
        max_length=100)  # permission = models.ManyToManyField(PermissionList, null=True, blank=True)
...
class TaskStatus(models.Model):
    ...
    forks = models.IntegerField(u"并发系数，请输入一个整数，默认值为5", null=True, blank=True)
