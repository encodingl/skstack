...
def permission_deny(request):
    ...
    return render_to_response('skaccounts/permission_deny.html', kwvars, RequestContext(request))
...
def permission_add(request):
    ...
    return render_to_response('skaccounts/permission_add.html', kwvars, RequestContext(request))
...
def permission_edit(request, ids):
    ...
    return render_to_response('skaccounts/permission_edit.html', kwvars, RequestContext(request))
