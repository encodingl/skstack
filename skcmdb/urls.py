...
urlpatterns = [
    ...
    url(r'asset/whileip_list$', ops.whileip_list, name='whileip_list'),
    url(r'asset/whileip_add$', ops.whileip_add, name='whileip_add'),
    url(r'asset/whileip_del$', ops.whileip_del, name='whileip_del'),
    url(r'asset/whileip_edit/(?P<ids>\d+)$', ops.whileip_edit, name='whileip_edit'),
