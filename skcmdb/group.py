...
def group(request):
    ...
    return render_to_response('skcmdb/group.html', locals(), RequestContext(request))
...
def group_add(request):
    ...
    if request.method == "POST":
        ...
        if group_form.is_valid():
            ...
            tips = u"增加失败！"
            display_control = ""
        return render_to_response("skcmdb/group_add.html", locals(), RequestContext(request))
    else:
...
def group_add_mini(request):
    ...
    if request.method == "POST":
        ...
        if group_form.is_valid():
            ...
            tips = u"增加失败！"
            display_control = ""
        return render_to_response("skcmdb/group_add_mini.html", locals(), RequestContext(request))
    else:
        display_control = "none"
        group_form = GroupForm()
        return render_to_response("skcmdb/group_add_mini.html", locals(), RequestContext(request))
...
def group_edit(request, ids):
    ...
    return render_to_response("skcmdb/group_edit.html", locals(), RequestContext(request))
